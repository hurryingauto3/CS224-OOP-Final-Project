...
bool Enemy::IsPlayerClose(GameObject *A)
{
...
void Enemy::ApproachPlayer(GameObject *A)
{
...
Enemy::Enemy(std::string Sprite, int xpos, int ypos) : GameObject(Sprite, xpos, ypos) { this->IsPlayerClosebool = false; }
Enemy::Enemy(std::string Sprite, int xpos, int ypos, int frames, int speed) : GameObject(Sprite, xpos, ypos, frames, speed) { this->IsPlayerClosebool = false; }
